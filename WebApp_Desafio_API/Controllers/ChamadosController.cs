...
namespace WebApp_Desafio_API.Controllers
{
    ...
    public class ChamadosController : Controller
    {
        ...
        /// <summary>
        /// Retorna um solicitante conforme solicitado no auto complete
        /// </summary>
        [HttpGet]
        [ProducesResponseType(typeof(bool), StatusCodes.Status200OK)]
        [ProducesResponseType(typeof(string), StatusCodes.Status400BadRequest)]
        ...
        public IActionResult BuscarSolicitantes([FromQuery] string solicitante)
        {
            try
            {
                var response = this.bll.BuscarSolicitantes(solicitante);
